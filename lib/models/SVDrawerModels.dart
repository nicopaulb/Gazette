...
List<SVDrawerModel> getDrawerOptions() {
  ...
  list.add(SVDrawerModel(image: 'images/socialv/icons/ic_Star.png', title: 'Paramètres'));
  list.add(SVDrawerModel(image: 'images/socialv/icons/ic_Logout.png', title: 'Se déconnecter'));
